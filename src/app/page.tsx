        ...
        <Fade cascade duration={1200} damping={0.1} fraction={0.1}>
            ...
            <div className={"content-card"}>
              <div>
                <p className="paragraph">
                  FedUp Concordia is a student-led movement dedicated to
                  improving food services on campus. We believe that students
                  deserve access to healthy, ethical, and affordable food
                  options that align with our values of sustainability and
                  social justice.
                </p>
                <p className="paragraph">
                  Our campaign began in response to widespread dissatisfaction
                  with Aramark, the current food service provider. In November
                  2024, 83% of Concordia students voted in favor of replacing
                  Aramark with a student-led, community-driven alternative.
                </p>
                <p className="paragraph">
          ...
          <section className="section">
            ...
            <div className={"content-card"}>
              ...
              <p className="paragraph">
                Join us in demanding a student-led, ethical, and sustainable
                food system on campus.
              </p>
              <p className="paragraph">
                Aramark’s presence on campus has led to numerous issues,
                including:
              </p>
              <ul className="list">
                <li>
                  Poor food quality, with reports of raw chicken, moldy fruit,
                  and bugs in meals.
                </li>
                <li>
                  High prices for low-quality food, especially for students on
                  meal plans.
                </li>
                <li>
                  Exploitation of prison labor in the U.S., which contradicts
                  our values.
                </li>
                <li>
          ...
          <section className="section">
            ...
            <div className={"content-card"}>
              <p className="paragraph">Visit the links below to:</p>
              <div className={"list"}>
                <ul className="list-disc list-inside text-pink-900">
                  ...
                  <li className="mt-2">
                    <a
                      ...
                      rel="noopener noreferrer"
                    >
                      Fill out a short survey about your experience with the
                      food on campus
                    </a>
                  </li>
                  <li className={"mt-2"}>
              ...
              <p className="paragraph">
                Your support is crucial to the success of this campaign. Here’s
              ...
              <ul className="list">
                ...
                <li>
                  <strong>Spread the word</strong> by sharing our campaign on
                  social media.
                </li>
                <li>
                  <strong>Join our team</strong> by visiting our{" "}
                  <Link href={"https://linktr.ee/fedupconcordia"}>
                    Linktree
                  </Link>{" "}
                  or messaging us on Instagram.
                </li>
                <li>
                  <strong>Give feedback</strong> about your experiences with
          ...
          <section className="section text-center">
            <h2 className="text-pink-950 text-3xl p-6">Join the Movement</h2>
            <p className="text-pink-950 mb-6 text-xl">
              Together, we can take control of our campus food services and
              create a model that benefits everyone. Let’s demand good food for
              all!
            </p>
            <a
